(function (global, factory) {
    ...
    function _setupEvents() {
        ...
        function _onTouchMove(e) {
            ...
            if (_SETTINGS.isPassive) {
                return false;
            };

            const $target = $(e.target);
            // don't trigger pull to refresh when inside a popup window
            if ($target.parents('.popup').length) {
                return false;
            };

            if (_SETTINGS.triggerElement.scrollTop !== 0)
                return;
    ...
    var pulltorefresh = {
        init: function init(options) {
            ...
            return {
                ...
                setPassive: function setPassive(isPassive) {
                    _SETTINGS.isPassive = typeof isPassive === 'boolean' ? isPassive : false;
                }
            };
        },
    };
